 ...
 * @author wuxz
 */
public class CallAgentImplNoUCCE implements CallAgent
{
	...
	public int atsAnswerCall(int port, int callId, int isBilling)
	{
		...
		// return handler == null ? Constant.ERR_RPC :
		// handler.atsAnswerCall(port,
		// callId, isBilling);
	}
	...
	public int atsInitialize(ISysCfgData sysCfgData)
	{
		...
		handler = channel.getPipeline().get(UCCEClientHandler.class);
